...
import { Autocomplete, Box, Button, Chip, Container, FormControl, FormHelperText, Grid, IconButton, InputAdornment, InputLabel, MenuItem, Modal, OutlinedInput, Select, TextField, Typography } from '@mui/material'
          ...
          <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
            <Grid container spacing={3} sx={{ maxWidth: 800 }}>
              ...
              <Grid item xs={12}>
                <Autocomplete
                  multiple
                  id="expense-members-autocomplete"
                  options={groupMembers || []}
                  value={values.expenseMembers}
                  onChange={(event, newValue) => {
                    formik.setFieldValue('expenseMembers', newValue);
                  }}
                  ...
                  renderInput={(params) => (
                    <TextField
                      ...
                      error={Boolean(touched.expenseMembers && errors.expenseMembers)}
                      helperText={touched.expenseMembers && errors.expenseMembers || "Select who should split this expense"}
                    />
                  )}
                  ...
                  noOptionsText="No group members available"
                />
              </Grid>
